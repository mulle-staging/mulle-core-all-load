...
if( NOT ${CMAKE_SYSTEM_NAME} MATCHES "Windows")
   if( COLLECT_ALL_LOAD_DEPENDENCY_LIBRARIES_AS_NAMES)
      ...
      if( NOT LIBBACKTRACE_LIBRARY)
         foreach( _TMP_LIBBACKTRACE_LIBRARY_TARGET backtrace LIBBACKTRACE_LIBRARY)
            if( TARGET ${_TMP_LIBBACKTRACE_LIBRARY_TARGET})
               set( LIBBACKTRACE_LIBRARY ${_TMP_LIBBACKTRACE_LIBRARY_TARGET})
               break()
            endif()
         endforeach()
         if( NOT LIBBACKTRACE_LIBRARY)
...
if( COLLECT_DEPENDENCY_LIBRARIES_AS_NAMES)
   ...
   if( NOT MULLE__ALLOCATOR_LIBRARY)
      foreach( _TMP_MULLE__ALLOCATOR_LIBRARY_TARGET mulle-core mulle-allocator MULLE__ALLOCATOR_LIBRARY)
...
if( COLLECT_DEPENDENCY_LIBRARIES_AS_NAMES)
   ...
   if( NOT MULLE__THREAD_LIBRARY)
      foreach( _TMP_MULLE__THREAD_LIBRARY_TARGET mulle-core mulle-thread MULLE__THREAD_LIBRARY)
...
if( COLLECT_DEPENDENCY_LIBRARIES_AS_NAMES)
   ...
   if( NOT MULLE__DLFCN_LIBRARY)
      foreach( _TMP_MULLE__DLFCN_LIBRARY_TARGET mulle-core mulle-dlfcn MULLE__DLFCN_LIBRARY)
